<template>
    <div ref="loginPopup" class="pop-up pop-up--login">
        <div class="pop-up__overlay"></div>

        <div class="auth-pop pop-up__container">
            <button :title="$t('login.close')" class="pop-up__close" @click="hide">
                <svg class="pop-up__icon pop-up__icon--x">
            ...
            <div class="pop-up__content" style="max-height: 938px">
                <div id="height-source" class="login">
                    ...
                    <div v-if="isSingup === false">
                        ...
                        <button
                            id="login-facebook"
                            class="login__cta button button--facebook button--large"
                            type="submit"
                        >
